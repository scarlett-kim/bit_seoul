import numpy as np
from tensorflow.keras.models import load_model #load_model에는 Sequential까지 포함되어있음 
from tensorflow.keras.layers import Dense, LSTM
#input을 변경할 수 있도록 변경해라 
...
model = load_model ('./save/keras.30.h5') #모델이 좋다면 저장

# keras.30.save.py 모델에서 + 플러스해서 모델을 더 추가하고 싶다 + keras.30.save.py 에서 input_shape 상관없이  
