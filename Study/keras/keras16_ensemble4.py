...
#모델 정의하기 
model = Model (inputs =[input1, input2], outputs =[output3, output4_3, output5])
                        #모델 1,2넣기 
model.summary()
...
model.fit(x1_train, [y2_train, y2_train, y3_train], epochs=100, batch_size=8, validation_split=0.25, verbose=1)
                                                        #ㄴy3추가
# 평가 
